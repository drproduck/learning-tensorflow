...
def train_model(model, batch_gen, num_train_steps, weights_fld):
    ...
    with tf.Session() as sess:
        ...
        writer = tf.summary.FileWriter('summary/skipgram' + str(LEARNING_RATE), sess.graph)
        ...
        for index in range(initial_step, initial_step + num_train_steps):
            ...
            if (index + 1) % SKIP_STEP == 0:
                ...
                summary_writer = tf.summary.FileWriter('processed/skipgram')
                ...
                saver_embed.save(sess, 'processed/skipgram/visual.ckpt', 1)
